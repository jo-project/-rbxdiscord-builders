...
import { ComponentTypes, RawTextInput, TextInput as ITextInput, TextInputStyles } from "rbx-discord";
...
export default class TextInput extends Component<ComponentTypes.TEXT_INPUT> {
    ...
    value?: string;
    authorId?: string;
    constructor(style: TextInputStyles, label: string, customID: string, authorId: string) {
