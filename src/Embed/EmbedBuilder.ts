...
type APIEmbedFieldName = string;
type APIEmbedFieldValue = string;
type APIEmbedFieldInline = boolean;
...
function renameKeys(obj : any, oldKey: string, newKey: string) {
	...
	Object.keys(obj).forEach(key => {
	  if (key === oldKey) {
		...
		renameKeys(obj[key], oldKey, newKey);
	  }
	});
  }
...
export class EmbedBuilder {
	 ...
	 *
	 * @remarks
	 * This method accepts string as name and value
	 * @example
	 * Using an array
	 * ```ts
	 * const fieldName: APIEmbedFieldName = ...;
	 * const fieldValue: APIEmbedFieldValue = ...;
	 * const fieldInline: APIEmbedFieldInline = ...;
	 * const embed = new EmbedBuilder()
	 ...
	 * ```ts
	 * const embed = new EmbedBuilder()
	 * 	.addField('Field Name', 'Field Value', FieldInline);
	 * ```
	 * @param name - The field name to add
	 * @param value - The field value to add
	 * @param inline - If field is inline or not
	 */
	public addField(name : APIEmbedFieldName, value: APIEmbedFieldValue, inline?: APIEmbedFieldInline): this {
		const field = {
			name: name,
			value: value,
			inline: inline
	...
	public build(): APIEmbed {
		renameKeys(this.data, 'icon_url', 'iconURL')
		return { ...this.data }
	}
